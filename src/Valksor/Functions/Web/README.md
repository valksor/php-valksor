...
[![BSD-3-Clause](https://img.shields.io/badge/BSD--3--Clause-green?style=flat)](https://github.com/valksor/php-functions-web/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/valksor/php-functions-web/badge.svg?branch=master)](https://coveralls.io/github/valksor/php-functions-web?branch=master)
